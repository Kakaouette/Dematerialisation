    ...
    public class Program
    {
        ...
        static private Master initImageModele(String master)
        {
            ...
            if (master.Equals("M2"))
            {
                ...
                p.rubriques.Add(new ZoneInfo(124, 504, 1720, 304, "Informations de l'étudiant"));
                p.rubriques.Add(new ZoneInfo(103, 865, 1780, 1838, "Voeux de l'étudiant"));
                ...
                p2.rubriques.Add(new ZoneInfo(101, 191, 1800, 1634, "Informations générales"));
                p2.rubriques.Add(new ZoneInfo(80, 1941, 1844, 701, "Cursus"));
